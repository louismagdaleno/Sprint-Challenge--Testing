...
Describe is used for describing a test and "it" is used for describing a test condition.
1. What is the point of `Test Driven Development`? What do you think about this approach?
TDD is designed to provide a solution to having good test coverage from the start using the red/green approach.
The same tests can be run again whenever changes are made to the codebase to ensure that the changes did not introduce any errors.
